...
export default function TadiandamolDetail({ onBack }) {
  ...
  const coorgData = {
    name: "Tadiandamol Peak, Coorg",
    description: "The highest peak in Coorg, offering a challenging yet rewarding trek with breathtaking views of the Shola forests",
    location: "Tadiandamol Peak, Coorg, Karnataka 571201",
    mapUrl: "https://maps.google.com/?q=Tadiandamol+Peak+Coorg",
    timing: {
    ...
    images: [
      "http://localhost:5000/images/tadiandamol_peak.jpg",
      "http://localhost:5000/images/tadiandamol-2.jpg"
    ]
  };
  ...
  const hotels = [
    {
      id: 1,
      type: "hotel",
      name: "Peak View Resort",
      contact: "+91-82736-61797",
      foodPrice: "₹1,500 - ₹3,500",
      address: "Near Tadiandamol Base, Coorg",
      mapUrl: "https://maps.google.com/?q=Peak+View+Resort+Coorg",
      image: "http://localhost:5000/images/peak-view-resort.jpg",
      distance: "5 km from Trek Base",
      rating: "4.4/5",
      amenities: ["Mountain View", "Trekking Guide", "Restaurant", "Camping"]
    }
  ];
  ...
  const homestays = [
    {
      id: 1,
      type: "homestay",
      name: "Trekker's Homestay",
      contact: "+91-94481-12353",
      foodPrice: "₹500 - ₹1,000",
      address: "Tadiandamol Road, Coorg",
      mapUrl: "https://maps.google.com/?q=Trekker+Homestay+Coorg",
      image: "http://localhost:5000/images/trekker-homestay.jpg",
      distance: "3 km from Trek Start",
      rating: "4.2/5",
      amenities: ["Trek Planning", "Home Food", "Equipment Rental", "Bonfire"]
    }
  ];
  ...
  const lodges = [
    {
      ...
      contact: "+91-97415-67898",
      foodPrice: "₹300 - ₹600",
      address: "Tadiandamol Base Camp, Coorg",
      mapUrl: "https://maps.google.com/?q=Base+Camp+Lodge+Coorg",
      image: "http://localhost:5000/images/base-camp-lodge.jpg",
      distance: "At Trek Starting Point",
      rating: "3.9/5",
      amenities: ["Trek Start Point", "Basic Stay", "Guide Service"]
    }
  ];
  ...
  const foodStalls = [
    {
      ...
      type: "food",
      name: "Trekker's Cafe",
      image: "http://localhost:5000/images/trekker-cafe.jpg",
      speciality: "Energy Bars & Trekking Snacks"
    },
    {
      id: 2,
      type: "food",
      name: "Mountain Food Stall",
      image: "http://localhost:5000/images/mountain-food.jpg",
      speciality: "Hot Soups & Local Coorg Meals"
    }
  ];
    ...
    return (
      <div style={{ position: "relative", textAlign: "center", padding: "20px", fontFamily: "Arial, sans-serif", maxWidth: "600px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "left", backgroundColor: "#f9f9f9", padding: "20px", borderRadius: "5px", border: "1px solid #eee" }}>
          ...
          <div style={{ marginTop: "20px", color: "#666" }}><p>📍 <strong>Location:</strong> Near Tadiandamol Trek Base</p><p>🕒 <strong>Timing:</strong> 5:00 AM - 6:00 PM</p><p>💰 <strong>Price Range:</strong> ₹50 - ₹250</p></div>
        </div>
      </div>
    );
  }
  ...
  const getSectionTitle = () => {
    switch (activeTab) {
      case "HOTEL": return "🏨 Hotels Near Tadiandamol Peak";
      case "Homestay": return "🏡 Homestays Near Tadiandamol Peak";
      case "Lodge": return "🛖 Lodges Near Tadiandamol Peak";
      case "Food Stall": return "🍽️ Food Stalls Near Tadiandamol Peak";
      default: return "";
    }
  };
