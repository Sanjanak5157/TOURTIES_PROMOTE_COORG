...
export default function ChikliholeDetail({ onBack }) {
  ...
  const coorgData = {
    name: "Chiklihole Reservoir, Coorg",
    description: "A scenic reservoir surrounded by lush greenery, perfect for nature photography and peaceful walks",
    location: "Chiklihole Reservoir, Coorg, Karnataka 571201",
    mapUrl: "https://maps.google.com/?q=Chiklihole+Reservoir+Coorg",
    timing: {
    ...
    images: [
      "http://localhost:5000/images/chiklihole_reservoir.jpg",
      "http://localhost:5000/images/chiklihole-2.jpg",
      "http://localhost:5000/images/chiklihole-3.jpg"
    ]
  };
  ...
  const hotels = [
    {
      ...
      contact: "+91-82736-61790",
      foodPrice: "₹800 - ₹2,000",
      address: "Near Chiklihole Reservoir, Coorg",
      mapUrl: "https://maps.google.com/?q=Coorg+Wilderness+Resort",
      image: "http://localhost:5000/images/wilderness-resort.jpg",
      distance: "3 km from Chiklihole Reservoir",
      rating: "4.2/5",
      amenities: ["Lake View", "Restaurant", "Nature Walk", "Free WiFi"]
    }
  ];
  ...
  const homestays = [
    {
      id: 1,
      type: "homestay",
      name: "Chiklihole View Homestay",
      contact: "+91-94481-12346",
      foodPrice: "₹300 - ₹600",
      address: "Chiklihole Road, Coorg",
      mapUrl: "https://maps.google.com/?q=Chiklihole+View+Homestay",
      image: "http://localhost:5000/images/chiklihole-homestay.jpg",
      distance: "1 km from Reservoir",
      rating: "4.0/5",
      amenities: ["Lake View", "Home Food", "Fishing", "Bonfire"]
    }
  ];
  ...
  const lodges = [
    {
      id: 1,
      type: "lodge",
      name: "Reservoir View Lodge",
      contact: "+91-97415-67891",
      foodPrice: "₹200 - ₹400",
      address: "Chiklihole Reservoir Road",
      mapUrl: "https://maps.google.com/?q=Reservoir+View+Lodge+Coorg",
      image: "http://localhost:5000/images/reservoir-lodge.jpg",
      distance: "500 m from Reservoir",
      rating: "3.8/5",
      amenities: ["Budget Stay", "Lake Access", "Boating"]
    }
  ];
  ...
  const foodStalls = [
    {
      id: 1,
      type: "food",
      name: "Chiklihole Lake View Cafe",
      image: "http://localhost:5000/images/lake-cafe.jpg",
      speciality: "Fresh Fish Fry & Local Coorg Snacks"
    }
  ];
    ...
    return (
      <div style={{ position: "relative", textAlign: "center", padding: "20px", fontFamily: "Arial, sans-serif", maxWidth: "600px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "left", backgroundColor: "#f9f9f9", padding: "20px", borderRadius: "5px", border: "1px solid #eee" }}>
          ...
          <div style={{ marginTop: "20px", color: "#666" }}><p>📍 <strong>Location:</strong> Near Chiklihole Reservoir, Coorg</p><p>🕒 <strong>Timing:</strong> 7:00 AM - 8:00 PM</p><p>💰 <strong>Price Range:</strong> ₹50 - ₹250</p></div>
        </div>
      </div>
    );
  }
  ...
  const getSectionTitle = () => {
    switch (activeTab) {
      case "HOTEL": return "🏨 Hotels Near Chiklihole Reservoir";
      case "Homestay": return "🏡 Homestays Near Chiklihole Reservoir";
      case "Lodge": return "🛖 Lodges Near Chiklihole Reservoir";
      case "Food Stall": return "🍽️ Food Stalls Near Chiklihole Reservoir";
      default: return "";
    }
  };
