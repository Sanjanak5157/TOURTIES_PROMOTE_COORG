...
export default function IruppuFallsDetail({ onBack }) {
  ...
  const coorgData = {
    name: "Iruppu Falls, Coorg",
    description: "A stunning, spiritual waterfall also known as Lakshmana Tirtha Falls, located amidst dense forests",
    location: "Iruppu Falls, Brahmagiri Range, Coorg, Karnataka 571247",
    mapUrl: "https://maps.google.com/?q=Iruppu+Falls+Coorg",
    timing: {
    ...
    images: [
      "http://localhost:5000/images/iruppu_falls.jpg",
      "http://localhost:5000/images/iruppu-falls-2.jpg",
      "http://localhost:5000/images/iruppu-falls-3.jpg"
    ]
  };
  ...
  const hotels = [
    {
      id: 1,
      type: "hotel",
      name: "Iruppu Falls Resort",
      contact: "+91-82736-61796",
      foodPrice: "₹1,200 - ₹3,200",
      address: "Brahmagiri Range, Near Iruppu Falls, Coorg",
      mapUrl: "https://maps.google.com/?q=Iruppu+Falls+Resort+Coorg",
      image: "http://localhost:5000/images/iruppu-resort.jpg",
      distance: "3 km from Falls",
      rating: "4.3/5",
      amenities: ["Waterfall View", "Trekking", "Restaurant", "Nature Walk"]
    }
  ];
  ...
  const homestays = [
    {
      ...
      contact: "+91-94481-12352",
      foodPrice: "₹450 - ₹900",
      address: "Brahmagiri Forest Road, Coorg",
      mapUrl: "https://maps.google.com/?q=Forest+Edge+Homestay+Coorg",
      image: "http://localhost:5000/images/forest-edge-homestay.jpg",
      distance: "2 km from Falls",
      rating: "4.1/5",
      amenities: ["Forest View", "Home Food", "Trekking Guide", "Bonfire"]
    }
  ];
  ...
  const lodges = [
    {
      ...
      contact: "+91-97415-67897",
      foodPrice: "₹350 - ₹700",
      address: "Iruppu Falls Road, Coorg",
      mapUrl: "https://maps.google.com/?q=Waterfall+View+Lodge+Coorg",
      image: "http://localhost:5000/images/waterfall-lodge.jpg",
      distance: "1 km from Falls",
      rating: "3.9/5",
      amenities: ["Waterfall Sound", "Basic Stay", "Nature Experience"]
    }
  ];
  ...
  const foodStalls = [
    {
      id: 1,
      type: "food",
      name: "Falls View Cafe",
      image: "http://localhost:5000/images/falls-cafe.jpg",
      speciality: "Fresh Fruit Juices & Local Snacks"
    },
    {
      id: 2,
      type: "food",
      name: "Forest Food Corner",
      image: "http://localhost:5000/images/forest-food.jpg",
      speciality: "Bamboo Rice & Traditional Coorg Dishes"
    }
  ];
    ...
    return (
      <div style={{ position: "relative", textAlign: "center", padding: "20px", fontFamily: "Arial, sans-serif", maxWidth: "600px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "left", backgroundColor: "#f9f9f9", padding: "20px", borderRadius: "5px", border: "1px solid #eee" }}>
          ...
          <div style={{ marginTop: "20px", color: "#666" }}><p>📍 <strong>Location:</strong> Near Iruppu Falls, Brahmagiri Range</p><p>🕒 <strong>Timing:</strong> 7:00 AM - 7:00 PM</p><p>💰 <strong>Price Range:</strong> ₹40 - ₹200</p></div>
        </div>
      </div>
    );
  }
  ...
  const getSectionTitle = () => {
    switch (activeTab) {
      case "HOTEL": return "🏨 Hotels Near Iruppu Falls";
      case "Homestay": return "🏡 Homestays Near Iruppu Falls";
      case "Lodge": return "🛖 Lodges Near Iruppu Falls";
      case "Food Stall": return "🍽️ Food Stalls Near Iruppu Falls";
      default: return "";
    }
  };
